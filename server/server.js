...
massive(REACT_APP_process.env.CONNECTION_STRING).then(db => app.set('db', db));
...
// ---------SESSIONS--------
app.use(session({
    secret: REACT_APP_process.env.SESSION_SECRET,
    resave: false,
...
passport.use(new Auth0Strategy({
    domain: REACT_APP_process.env.AUTH_DOMAIN,
    clientID: REACT_APP_process.env.AUTH_CLIENT_ID,
    clientSecret: REACT_APP_process.env.AUTH_CLIENT_SECRET,
    callbackURL: REACT_APP_process.env.AUTH_CALLBACK_URL,
